...
//文件信息请求
#define _DEF_FILE_INFO_RQ                  (_DEF_PROTOCOL_BASE + 11)
//文件块请求
#define _DEF_FILE_BLOCK_RQ                 (_DEF_PROTOCOL_BASE + 12)
//文件信息回复
#define _DEF_FILE_INFO_RS                  (_DEF_PROTOCOL_BASE + 13)
//文件信息
#define _DEF_FILE_INFO					   (_DEF_PROTOCOL_BASE + 14)
//声明结果宏
//注册结果
